           ...
           <table class="order-table">
            ...
            <tbody>
              <tr>
                ...
                <td>\'$row['FirstName'];\'</td>
                <td class="ordermeal">\'$row['MealName'];\'</td>
                <td>\'$row['AddOnMenuName'];\'</td>
                <td>\'$row['AddOnQuantity'];\'</td>
                <td class="orderremarks">\'$row['Remarks'];\'</td>
                <td>\'$row['OrderDate'];\'</td>
                <td>\'$row['DeliveryDate'];\'</td>
                <td class="orderstatus">\'$row['OrderStatus'];\'</td>
                <td class="orderstaffincharge">\'$row['StaffFName'];\'</td>
